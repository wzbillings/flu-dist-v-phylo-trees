...
the maximum likelihood tree based on the SH test, and these trees also had
higher RF distance from the ML tree than the Grantham and $p$-Epitope distance
trees. For the H3N2 strains, the temporal and Grantham distance trees were
similar to the ML tree, the $p$-Epitope tree had a larger likelihood decrease,
and the cartographic tree was very different from the ML tree. All of the
changes in log likelihood for the H3N2 trees were smaller in magnitude than for
H1N1. Notably, the temporal distance tree had a much lower likelihood than the
ML model for H1N1.
