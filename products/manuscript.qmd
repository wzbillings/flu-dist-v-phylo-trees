...
The distance metrics differed in their agreement with ML-tree cophenetic
distance (@fig-corr; @tbl-distance-correlations). Grantham and $p$-Epitope
distances were strongly correlated with ML-tree distance for both subtypes,
while cartographic distance had lower correlations. Temporal distance was
strongly correlated with ML-tree distance for H3N2, but not for H1N1. H1N1 has
...
#|   ML-tree cophenetic distance, overall and by subtype.

here::here("results", "Tables", "distance-correlation-table.rds") |>
	readr::read_rds()
```
