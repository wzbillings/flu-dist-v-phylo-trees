...
resampling over strain units. Descriptive Pearson correlations using the same
unique off-diagonal pair representation are reported in the supplement for
interpretability.
